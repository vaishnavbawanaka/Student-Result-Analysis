            ...
            try {
                ...
                try {
                    ...
                    while (it.hasNext()) {
                        ...
                        if (fileItem.getFieldName().equals("index1")) {
                            index1 = fileItem.getString();
                            System.out.println("File Name" + index1);
                        ...
                        if (isFormField) {
                            ...
                            try {
                                ...
                                pstm = con.prepareStatement("insert into file (file,filetype, filename, index1, data,owner)values(?,?,?,?,?,?)");
