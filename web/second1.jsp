...
<%
	...
	con = Dbconnection.getConnection();
       ...
       PreparedStatement pstmt=con.prepareStatement("update second set sub1="+sub1+",sub2="+sub2+",sub3="+sub3+",sub4="+sub4+",sub5="+sub5+",sub6="+sub6+",sub7="+sub7+",sub8="+sub8+" where no='"+no+"'");
    ...
    if (i != 0) {
           response.sendRedirect("editmarks.jsp?second=success");
       }
   
}
catch(Exception e1)
{
    response.sendRedirect("editmarks.jsp?second1=Email Id you Entered already in Use");
