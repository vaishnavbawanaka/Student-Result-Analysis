...
<%
    ...
    String name = request.getParameter("sem");
    ...
    if (i != 0) {
           response.sendRedirect("editstudentdetails.jsp?userreg=success");
       }
   
}
catch(Exception e1)
{
    response.sendRedirect("editstudentdetails.jsp?userreg1=Email Id you Entered already in Use");
