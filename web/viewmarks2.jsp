  ...
  <!-- Controls -->
    ...
    con = Dbconnection.getConnection();
     Statement st;
            ...
            rs = st.executeQuery("select * from first where no='"+uid+"'");
         ...
         <br><br><br>
           ...
           <tr>
            ...
            <tr>
             <th  width="179" valign="middle" align="center" height="48" style="color: #00CC99;"><div class="style9">computer networks</div></th>
