    ...
    <span class="glyphicon glyphicon-chevron-right"></span>
      ...
      <div class="featured-block">
        <div class="col-md-4">
            ...
            <form action="studentregact.jsp" method="post" id="" >
                
                
                <br>  <br><br><br><br><br><br><br><h1> Student Registration  </h1><br><br><br><br><br>
                
					  <table width="350">
                      
			 <tr>
                          <th width="191" height="43"><font color="black">Student Name </th>
                        ...
                        <tr>
                          ...
                          <td><select id="s1" name="gen" style="width:170px;" class="text" required="">
                           ...
                           <tr>
                          <th height="43"><font color="black">Select Semester</th>
                          <td><select id="s1" name="sem" style="width:170px;" class="text" required="">
                            <option>--Select--</option>
                            <option>3-1</option>
                            <option>3-2</option>
                          </select></td>
